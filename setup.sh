...
akbarvpn="raw.githubusercontent.com/putrapetirr0/autoscriptmod_araz/main/ssh"
...
# Link Hosting Kalian Untuk Warp
arazvpn="https://raw.githubusercontent.com/putrapetirr0/ARAZ/main/warp%20cloudflare/warp.sh"
...
# Ohp Server
wget https://${arazvpn}/warp.sh && chmod +x warp.sh && ./warp.sh
