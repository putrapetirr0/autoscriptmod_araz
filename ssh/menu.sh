...
echo -e "$y-------------------------------------------------------------$wh"
echo -e "$y             Telegram : https://t.me/araz1308 $wh"
echo -e "$y           Premium Auto Script By araz1308 $wh"
echo -e "$y-------------------------------------------------------------$wh"
echo ""
...
echo -e "$yy 53$y.backup-telegram"
echo -e "$yy 54$y.Restore Data VPS"
echo -e "$yy 55$y.Webmin Menu"
echo -e "$yy 56$y.Limit Bandwith Speed Server"
echo -e "$yy 57$y.Check Usage of VPS Ram"
echo -e "$yy 58$y.Reboot VPS"
echo -e "$yy 59$y.Speedtest VPS"
echo -e "$yy 60$y.Displaying System Information"
echo -e "$yy 61$y.Info Script Auto Install"
echo -e "$y-------------------------------------------------------------$wh"
echo -e ""
